package com.example.tleapplication.support.config
...
class SwaggerConfiguration {
    ...
    fun openApi(): OpenAPI {
        return OpenAPI()
            ...
            .info(
                Info()
                    .title("Three Lines Economy API")
                    .description(description)
                    .version(version),
            )
            .externalDocs(
                ExternalDocumentation()
                    .description("Three Lines Economy API"),
            )
    }

    @Bean
    fun customOpenApiCustomiser(): OpenApiCustomizer = OpenApiCustomizer { openApi ->
